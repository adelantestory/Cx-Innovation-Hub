...
Use the Figma MCP server for Figma-driven implementation. For setup and debugging details (env vars, config, verification), see `.agents/skills/figma/references/figma-mcp-config.md`.
...
## References
- `.agents/skills/figma/references/figma-mcp-config.md` — setup, verification, troubleshooting, and link-based usage reminders.
- `.agents/skills/figma/references/figma-tools-and-prompts.md` — tool catalog and prompt patterns for selecting frameworks/components and fetching metadata.
